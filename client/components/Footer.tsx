        ...
        <div className="flex flex-col md:flex-row justify-between gap-12 md:gap-8">
          ...
          <div className="space-y-6 md:space-y-8 flex flex-col items-center md:items-start md:w-1/3">
            ...
            <div className="flex gap-4 justify-center md:justify-start">
              <a href="https://www.instagram.com/beeliber" target="_blank" rel="noopener noreferrer" title="Instagram" aria-label="Instagram" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-bee-yellow group transition-all">
              ...
              <a href="https://www.threads.net/@beeliber" target="_blank" rel="noopener noreferrer" title="Threads" aria-label="Threads" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-bee-yellow group transition-all">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-white group-hover:text-bee-black transition-colors">
