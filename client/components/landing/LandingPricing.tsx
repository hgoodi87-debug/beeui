                    ...
                    {prices.map((item, i) => (
                        ...
                        >
                            ...
                            <button
                                ...
                                className={`w-full py-5 md:py-8 rounded-[1.5rem] md:rounded-[2rem] font-black text-lg md:text-2xl tracking-[0.1em] transition-all shadow-2xl active:scale-95 flex items-center justify-center gap-3 ${item.popular ? 'bg-bee-black text-bee-yellow hover:bg-bee-yellow hover:text-bee-black' : 'bg-bee-yellow text-bee-black hover:bg-bee-black hover:text-bee-yellow'
                                    }`}
                            >
