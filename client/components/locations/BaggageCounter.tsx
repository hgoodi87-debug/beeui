                        ...
                        <div key={category.id} className="overflow-hidden rounded-[2rem] border border-gray-100 bg-white shadow-[0_14px_40px_rgba(15,23,42,0.06)] transition-all hover:-translate-y-0.5 hover:border-bee-yellow/70 hover:shadow-[0_20px_50px_rgba(15,23,42,0.09)]">
                            <div className="p-4 sm:p-5">
                                <div className="flex items-start gap-4">
                                    <div className={`flex h-24 w-24 shrink-0 items-center justify-center rounded-[1.5rem] bg-gradient-to-br ${visual.accentClassName}`}>
                                        <img
                                            src={visual.imageSrc}
                                            alt={label}
                                    ...
                                    <div className="min-w-0 flex-1">
                                        <div className="flex items-start justify-between gap-3">
                                            <div className="min-w-0">
                                                ...
                                                <div className="mt-1 text-lg font-black leading-tight text-bee-black">
                                                    {label}
                                                </div>
                                            ...
                                            <div className={`rounded-2xl px-4 py-2 text-center ${visual.chipClassName}`}>
