    ...
    qna: {
        ...
        items: [
            ...
            },
            {
                ...
                answer: "機内持ち込みサイズのバッグから大型スーツケース、リュック、ショッピングバッグまで、ほとんどの荷物をお預かりできます。\n\n料金（サイズ別）：\n• 小型（機内持込 / ハンドバッグ）— ₩3,000/日\n• 中型（24〜28インチのスーツケース）— ₩5,000/日\n• 大型（29インチ以上）— ₩7,000/日\n\nベビーカー・キックボード・小型自転車は拠点の空きスペース次第となりますので、予約時にお問い合わせください。\n\n⚠️ 現金・貴重品（50万ウォン超）・食品・危険物はお預かりできません。"
            },
            {
                category: "booking",
            ...
            },
            {
                ...
                answer: "基本補償の上限は1件あたり最大50万ウォンです。\n\n予約時に「安心保証オプション」を追加すると、最大300万ウォンまで補償額が上がります。\n\n破損・紛失が発生した場合は、預け入れ時の写真と領収書を添付してメールでご申告ください。処理手順をご案内いたします。\n\n⚠️ 現金・貴重品・個人の電子機器は基本補償範囲外となります。"
            },
            {
                category: "booking",
            ...
            },
            {
                ...
                answer: "以下の物品はお預かりできません：\n\n• 現金・パスポート・重要書類\n• 50万ウォン超の貴重品・宝飾品\n• 食品・腐敗しやすいもの\n• 爆発物・引火性物質・危険物\n• 生き物\n\nノートPC・カメラなどの電子機器はお預かり可能ですが、破損時の補償範囲が限られる場合がありますので「安心保証オプション」の加入をお勧めします。"
            },
            {
                category: "general",
