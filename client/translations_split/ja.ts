export const ja = {
    seo: {
        title: 'Beeliber | ソウル荷物預かり — 弘大・明洞・聖水・江南',
        description: '弘大・明洞・聖水など首爾の人気エリアで手荷物預かり。4時間₩4,000〜。毎日09:00–22:00営業。予約不要、そのまま来店OK。チェックアウト後も身軽に首爾を満喫。',
        keywords: 'ソウル荷物預かり, 弘大荷物預かり, 明洞荷物預かり, 聖水荷物預かり, ソウル旅行荷物, チェックアウト後荷物, ソウル手荷物料金, 韓国旅行最終日',
    ...
    qna: {
        ...
        items: [
            {
                category: "general",
                question: "Beeliber（ビリーバー）とはどんなサービスですか？初めての方はどう使えばいいですか？",
            ...
            {
                category: "general",
                question: "どんな荷物を預けられますか？サイズや重量の制限はありますか？",
            ...
            {
                category: "booking",
                question: "空港配送はどう申し込みますか？何時までに予約すればいいですか？",
            ...
            {
                category: "booking",
                question: "受け取り時間より遅くなった場合や、フライトが遅延した場合はどうなりますか？",
            ...
            {
                category: "safety",
                question: "荷物が破損・紛失した場合、どれくらい補償されますか？",
