    ...
    qna: {
        ...
        items: [
            ...
            },
            {
                ...
                answer: "基本赔偿上限为每件最高 50 万韩元。\n\n预约时加购「安心保障选项」，赔偿上限可提升至最高 300 万韩元。\n\n发生损坏或遗失时，请附上寄放时的照片及收据，以电子邮件申报，我们将说明处理程序。\n\n⚠️ 现金、贵重品、个人电子产品不在基本赔偿范围内。"
            },
            {
                category: "booking",
            ...
            },
            {
                category: "general",
                question: "有哪些物品不能寄放？",
                answer: "以下物品不可寄放：\n\n• 现金、护照、重要文件\n• 贵重品、珠宝等超过 50 万韩元的物品\n• 食品、易腐物品\n• 爆炸物、易燃物、危险品\n• 活体动物\n\n笔记本电脑、相机等电子产品可以寄放，但损坏时赔偿范围有限，建议加购「安心保障选项」。"
            },
            {
                category: "general",
