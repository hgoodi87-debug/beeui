...
def fix_zh(path):
    ...
    # Fix howitworks syntax error and airport theme
    # pricing golf bag removal
    new_content = """export const zh = {
    seo: {
    ...
    hero: {
        ...
        title1: '放下行李',
        title2: '开启自由旅行。',
        subtitle: '从机场到酒店，沉重的行李交给 Beeliber，\\n轻便享受在韩国的每一刻。',
        btn_now: '立即减负 ➔',
    ...
    trust: {
        ...
        tracking: { title: "100% 实时追踪", desc: "基于 GPS 实时查看行李的移动路线和当前状态。" },
    ...
    pricing: {
        ...
        price_extra: "₩29,000",
        features_standard: ["23英寸以下所有尺寸", "机场 ↔ 酒店当日配送", "实时位置查询", "包含基础损坏保险"],
    ...
    booking: {
        ...
        agree_premium_checklist: '确认禁止携带物品清单 and 赔偿政策',
...
# Fix paths (absolute paths)
fix_zh(r'c:\Users\dbcjs\Desktop\beeliber\beeliber\beeliber-main-main\beeliber-main\client\translations_split\zh.ts')
